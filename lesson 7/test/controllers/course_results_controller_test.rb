...
class CourseResultsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_result" do
    assert_difference('CourseResult.count') do
      post course_results_url, params: { course_result: { created_at: @course_result.created_at, eur: @course_result.eur, rur: @course_result.rur, usd: @course_result.usd } }, as: :json
    end
  ...
  test "should update course_result" do
    patch course_result_url(@course_result), params: { course_result: { created_at: @course_result.created_at, eur: @course_result.eur, rur: @course_result.rur, usd: @course_result.usd } }, as: :json
    assert_response 200
  end
